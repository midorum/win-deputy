...
public class CheckProcessor {
    ...
    public boolean verifyCheck(final Check check) {
        return switch (check.getType()) {
            ...
            case stampFound -> getStamp(check.getData()).isPresent();
            case stampNotFound -> getStamp(check.getData()).isEmpty();
        };
    }
    ...
    private Optional<Stamp> getStamp(final Map<CheckDataType, String> data) {
        ...
        return cache.getStamp(stampPath);
    }
